     ...
     const handleDelete = async (id) => {
          if (confirm("Are you sure you want to delete this ?")) {
               try {
                    ...
                    alert(res.data.message); // show backend message "Deleted Successfully"
                              ...
                              loading ? (
                                   ...
                                   <div className='flex items-center text-xl' key={msg.id}>
                                        ...
                                        <p className='mr-1 cursor-pointer' onClick={() => handleEdit(msg.id, msg.text)} >
                                             <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="black" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pencil-icon lucide-pencil"><path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z" /><path d="m15 5 4 4" /></svg>
                                        </p>
